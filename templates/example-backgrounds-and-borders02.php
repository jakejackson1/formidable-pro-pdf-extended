...
<head>
	...
	<body>
        ...
        foreach($lead_ids as $lead_id) {
            ...
            <div style="border:0.1mm solid #880000; background: transparent url(<?php echo FP_PDF_PLUGIN_DIR; ?>/images/bg.jpg) repeat fixed right top; background-color:#ccffff; ">
