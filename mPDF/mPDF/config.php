...
// TABLES
(defined('FP_PDF_ENABLE_SIMPLE_TABLES') && PDF_ENABLE_SIMPLE_TABLES === true) ? $this->simpleTables = true : $this->simpleTables = false; // Forces all cells to have same border, background etc. Improves performance
